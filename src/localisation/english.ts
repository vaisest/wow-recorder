...
const ENGLISH: Translations = {
  ...
  [Phrase.ObsFPSDescription]: 'The number of frames per second to record the video at. Lower FPS gives smaller video size, but also more choppy playback. Higher FPS settings also load the encoder more. Depending on the encoding hardware and other recording apps in the background, an overloaded encoder can cause frames to be dropped.',
  ...
  [Phrase.ObsQualityDescription]: 'Quality to record at. Higher quality uses more disk space per video, but have fewer compression artifacts. Represents constant quality, meaning that the file size should vary based on the complexity and frame rate of the video, but the visual quality should remain constant.',
